...
pub unsafe fn vm_eval(vm: &mut VM) -> Result<Value, Value> {
    ...
    'eval: loop {
        ...
        'interp: loop {
            ...
            let op: Opcode = std::mem::transmute(pc.read());
            let opcode = op;
            #[cfg(feature = "profile-opcodes")]
            {
            ...
            match op {
                ...
                Opcode::Addi => {
                    ...
                    if x.is_int32() {
                        if let Some(res) = x.get_int32().checked_add(y) {
                    ...
                    if unlikely(!x.is_number()) {
                        throw!(wrong_contract::<()>("+", "number?", 0, 2, &[x, y.into()]));
                    }

                    push!(arith_add(vm, x, y.into()).unwrap_unchecked())
                }
                ...
                Opcode::Subi => {
                    ...
                    if x.is_int32() {
                        if let Some(res) = x.get_int32().checked_sub(y) {
                            push!(Value::encode_int32(res));
                            #[cfg(feature = "profile-opcodes")]
                            {
                                PROFILE[opcode as usize].time += start.elapsed().as_nanos() as u64;
                    ...
                    push!(arith_sub(vm, x, y.into()).unwrap_unchecked())
                }
                ...
                Opcode::Muli => {
                    ...
                    if x.is_int32() {
                        if let Some(res) = x.get_int32().checked_mul(y) {
                            push!(Value::encode_int32(res));
                            #[cfg(feature = "profile-opcodes")]
                            {
                                PROFILE[opcode as usize].time += start.elapsed().as_nanos() as u64;
                    ...
                    push!(arith_mul(vm, x, y.into()).unwrap_unchecked())
                }
                ...
                Opcode::Quotienti => {
                    ...
                    if x.is_int32() {
                        if let Some(res) = x.get_int32().checked_div(y) {
                            push!(Value::encode_int32(res));
                            #[cfg(feature = "profile-opcodes")]
                            {
                                PROFILE[opcode as usize].time += start.elapsed().as_nanos() as u64;
                    ...
                    push!(arith_quotient(vm, x, y.into()).unwrap_unchecked())
                }
                ...
                Opcode::Quotient => {
                    ...
                    let res = arith_quotient(vm, x, y).unwrap_unchecked();
                ...
                Opcode::TupleRef => {
                    ...
                    if unlikely(!val.is_tuple()) {
                        throw!(wrong_contract::<()>("tuple-ref", "tuple?", 0, 2, &[val, n],));
                    }
                ...
                Opcode::TupleRefI => {
                    ...
                    if unlikely(!val.is_tuple()) {
                        throw!(wrong_contract::<()>(
                            ...
                            0,
                            2,
                            &[val, Value::encode_int32(n as _),],
                        ));
                    }

                    push!(val.tuple()[n as usize]);
                }
                ...
                Opcode::TupleSet => {
                    ...
                    vm.thread.write_barrier(val.tuple());
                    val.tuple()[n] = new_val;
                }
                ...
                Opcode::TupleSetI => {
                    ...
                    if unlikely(!val.is_tuple()) {
                        throw!(wrong_contract::<()>(
                            ...
                            0,
                            3,
                            &[val, Value::encode_int32(n as _), new_val],
                        ));
                    }

                    vm.thread.write_barrier(val.tuple());
                    val.tuple()[n as usize] = new_val;
                }
