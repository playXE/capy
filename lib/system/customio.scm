                        ...
                        (define (decode3)
                          (if (<= 3 count)
                              (let* ((unit2
                                     ...
                                     (sv
                                      (fxior
                                       (fxlsh (fxlogand unit1 15) 12)
                                       (fxlsh (fxlogand unit2 63) 6)
                                       (fxlogand unit3 63))))
                                (string-set! s i (integer->char sv))
                                (continue 3))
                              (loop2 s 0 i)))
                        ...
                        (define (decode4)
                          (if (<= 4 count)
                              (let* ((unit2
                                     ...
                                     (sv
                                      (fxior
                                       (fxlsh (fxlogand unit1 7) 18)
                                       (fxlsh (fxlogand unit2 63) 12)
                                       (fxlsh (fxlogand unit3 63) 6)
                                       (fxlogand unit4 63))))
                                (string-set! s i (integer->char sv))
                                (continue 4))
                              (loop2 s 0 i)))
             ...
             (write-method
              (lambda (data buffer count)
                ...
                (let ((bv (make-bytevector count)))
                  (r6rs:bytevector-copy! buffer 0 bv 0 count)
