...
(define ex:unspecified (undefined))
...
(define capy:execution-mode (make-parameter "capy:execution-mode" 'r6rs))
(define capy:r6rs-expand-only (make-parameter "capy:r6rs-expand-only" #f))